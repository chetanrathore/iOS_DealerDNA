...
class ProfileVC: UIViewController , CustomNevigationDeletegate {
    ...
    func setLayout() {
        ...
        customNav.createView(self.view, title: "Profile", backBtn: .back, rightBtnTitle: nil, rightButtonImage: nil)
